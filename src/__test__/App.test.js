...
const response = {data: {
  ...
  "_embedded": {
      "episodes": [
          ...
          }//this closes episode 8
        ]//this closes the episodes array
      }//this closes the embedded
}//this closes the response data
}//this closes the const response
